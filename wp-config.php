...
// Last sync: r25001
// ** Настройки за MySQL ** //
define('DB_NAME', 'dag48m4jmi5i7c');     // Име на базата от данни
define('DB_USER', 'eqizcpkyokhuro');     // Вашето потребителско име за MySQL сървъра
define('DB_PASSWORD', '8QTra9aoeVEuigTJ53We4MmP9e'); // ...и паролата
define('DB_HOST', 'ec2-54-235-246-73.compute-1.amazonaws.com:5432');     // Адрес на MySQL сървъра. 99% сигурно е, че е localhost
